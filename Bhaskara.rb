...
class Bhaskara
	...
	def initialize()
		...
		# NAO É NECESSÁRIO COLOCAR NO INITIALIZE. O RUBY ENTENTE
		# QUE ESSA VARIAVEL É DE INSTANCIA SE ELA FOR DECLARADA EM 
		# QUALQUER METODO
		# SÓ ESTÁ AQUI PRA FACILITAR A VISUALIZAÇÃO E ENTENDIMENTO
